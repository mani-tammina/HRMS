...
Object.assign(swaggerSpec.paths, {
  ...
  "/api/payroll/templates": {
    get: {
      summary: "List salary structure templates",
      tags: ["Payroll"],
      security: [{ bearerAuth: [] }],
  ...
  "/api/payroll/templates/{id}": {
    put: {
      summary: "Update salary structure template",
      tags: ["Payroll"],
      security: [{ bearerAuth: [] }],
      parameters: [
        { name: "id", in: "path", required: true, schema: { type: "integer" } },
    ...
    delete: {
      summary: "Delete salary structure template",
      tags: ["Payroll"],
      security: [{ bearerAuth: [] }],
      parameters: [
        { name: "id", in: "path", required: true, schema: { type: "integer" } },
      ],
      responses: { 200: { description: "Deleted template" } },
    },
  },
  "/api/payroll/template/{templateId}/components": {
    get: {
      summary: "List components in template",
      tags: ["Payroll"],
      security: [{ bearerAuth: [] }],
      parameters: [
        {
      ...
      responses: { 200: { description: "Array of template components" } },
    },
    post: {
      ...
      responses: { 200: { description: "Added component" } },
    },
  },
  "/api/payroll/template/{templateId}/components/{id}": {
    put: {
      ...
      responses: { 200: { description: "Updated template component" } },
    },
    delete: {
      summary: "Delete template component",
      tags: ["Payroll"],
      security: [{ bearerAuth: [] }],
      parameters: [
        {
      ...
      responses: { 200: { description: "Deleted template component" } },
    },
  },
  "/api/payroll/contracts": {
    ...
    post: {
      ...
      responses: { 200: { description: "Created contract" } },
    },
  },
  "/api/payroll/contracts/{id}": {
    ...
    delete: {
      ...
      responses: { 200: { description: "Deleted contract" } },
    },
  },
  "/api/payroll/periods": {
    get: {
      ...
      tags: ["Payroll"],
      security: [{ bearerAuth: [] }],
      responses: { 200: { description: "Array of periods" } },
    },
    post: {
      ...
      responses: { 200: { description: "Created period" } },
    },
  },
  "/api/payroll/periods/{id}": {
    put: {
      ...
      responses: { 200: { description: "Updated period" } },
    },
    delete: {
      ...
      responses: { 200: { description: "Deleted period" } },
    },
  },
  "/api/payroll/payslips": {
    get: {
      ...
      tags: ["Payroll"],
      security: [{ bearerAuth: [] }],
      responses: { 200: { description: "Array of payslips" } },
    },
  },
  "/api/payroll/payslips/{id}": {
    get: {
      ...
      responses: { 200: { description: "Payslip object" } },
    },
  },
  "/api/payroll/payslips/{id}/items": {
    get: {
      summary: "List payslip items",
      tags: ["Payroll"],
      security: [{ bearerAuth: [] }],
      parameters: [
        { name: "id", in: "path", required: true, schema: { type: "integer" } },
      ],
      responses: { 200: { description: "Array of payslip items" } },
    },
  },
  "/api/payroll/run": {
    post: {
      ...
      responses: { 200: { description: "Payroll run result" } },
    },
  },
